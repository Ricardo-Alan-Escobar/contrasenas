            ...
            <div className="bg-zinc-900 w-full max-w-lg rounded-xl p-6">
                ...
                <div className="flex justify-between items-center">
                    <h2 className="text-2xl font-semibold text-card-foreground flex items-center gap-2">
                        <Package className="w-7 h-7 text-green-500 bg-zinc-800 p-1 rounded-md" />
                        ...
                        />
                           ...
                           <div className="flex-1">
                            ...
                            <input
                                ...
                                step="0.01"
                                placeholder="0.00"
                                className="bg-secondary border-border focus:border-green-500 focus:ring-green-500 rounded-md w-full p-2 pl-8"
