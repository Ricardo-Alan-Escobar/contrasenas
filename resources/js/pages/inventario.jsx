...
import { Package, Box, AlertTriangle, PackageX, MoreVertical, Minus, Plus, Search } from 'lucide-react';
import {
    DropdownMenu,
    DropdownMenuContent,
    DropdownMenuItem,
...
export default function Inventario({ items }) {
    ...
    const enStock = items.filter(item => item.cantidad_inicial > item.stock_minimo).length;
            ...
            <div className="p-6 space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6">
                        <div className="flex items-start justify-between">
                            <div>
                                <p className="text-zinc-400 text-sm mb-1">En Stock</p>
                                <p className="text-3xl font-bold text-white">{enStock}</p>
                            </div>
                            <div className="bg-green-500/10 p-3 rounded-lg">
                ...
                <div className="flex items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        >
                            <Plus className="mr-2" size={18} /> Nuevo toner
                        </button>
                    </div>
                </div>
                    ...
                    {filteredItems.length === 0 && (
                        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-12 text-center">
                            ...
                            <p className="text-zinc-400 text-sm">
                                {searchTerm ? 'No se encontraron resultados.' : 'No hay toner registrados.'}
                            </p>
                        </div>
                    )}
